...
from information_Retrieval_2 import InformationRetrieval
...
class SearchEngine:
    ...
    def evaluateDataset(self):
        ...
        plt.legend()
        plt.title("Evaluation Metrics - Cranfield Dataset- Improved Model-1")
        plt.xlabel("k")
        plt.ylabel("Score")
        plt.grid(True)
        plt.savefig(args.out_folder + "eval_plot_1.png")
        plt.close()
